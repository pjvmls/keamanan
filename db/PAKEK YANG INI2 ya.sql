...
-- Membuang data untuk tabel rental.tbl_jadwal: ~8 rows (lebih kurang)
...
INSERT INTO `tbl_jadwal` (`id_jadwal`, `id_penyewa`, `id_supir`, `id_mobil`, `supir`, `alamat_sewa`, `tanggal`, `lama_hari`, `jam`, `status_jadwal`) VALUES
	...
	(17, 9, 4, 1, 'true', 'jalan buntu', '2019-07-17', 3, NULL, 'finish'),
	(18, 9, 5, 1, 'true', 'jalan buntu', '2019-07-15', 3, NULL, 'finish'),
	(19, 9, 7, 1, 'true', 'jalan buntu', '2019-07-16', 7, NULL, 'finish'),
	(20, NULL, 0, 1, 'true', NULL, '2019-07-19', 3, NULL, 'waiting'),
	(21, NULL, 0, 1, 'true', NULL, '2019-07-18', 3, NULL, 'waiting'),
	(22, NULL, 0, 1, 'true', NULL, '2019-07-18', 3, NULL, 'waiting'),
	(23, NULL, 0, 1, 'true', NULL, '2019-07-19', 3, NULL, 'waiting'),
	(24, NULL, 0, 1, 'true', NULL, '2019-07-18', 3, NULL, 'waiting');
...
INSERT INTO `tbl_mobil` (`id_mobil`, `nama_mobil`, `gambar`, `tahun_keluar`, `jenis`, `qty`, `harga`) VALUES
	(1, 'agya', 'assets/img/mobil/agya.png', '2019', 'AT', 3, 3000010),
...
-- Membuang data untuk tabel rental.tbl_transaksi: ~8 rows (lebih kurang)
